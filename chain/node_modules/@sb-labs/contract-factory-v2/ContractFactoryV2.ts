...
import NFT_Register from "@sb-labs/web3-data/contracts/NFT_Register.json" assert {"type" : "json"}

// Dapp
import UserRegister from "@sb-labs/web3-data/contracts/UserRegister.json" assert {"type" : "json"}

import Messages from "@sb-labs/web3-data/contracts/Messages.json" assert {"type" : "json"}

import Feed from "@sb-labs/web3-data/contracts/Feed.json" assert {"type" : "json"}

import FeedViewer from "@sb-labs/web3-data/contracts/FeedViewer.json" assert {"type" : "json"}

import CryptoRicks from "@sb-labs/web3-data/contracts/CryptoRicks.json" assert {"type" : "json"}

import VRFHelper from "@sb-labs/web3-data/contracts/VRFHelper.json" assert {"type" : "json"}

import Shop from "@sb-labs/web3-data/contracts/Shop.json" assert {"type" : "json"}

import MockUSDC from "@sb-labs/web3-data/contracts/MockUSDC.json" assert {"type" : "json"}

import StevesTees from "@sb-labs/web3-data/contracts/StevesTees.json" assert {"type" : "json"}

import AgeUpdater from "@sb-labs/web3-data/contracts/AgeUpdater.json" assert {"type": "json" }

import UserAgeManager from "@sb-labs/web3-data/contracts/UserAgeManager.json" assert { "type" : "json" }

import TransparentUpgradableProxy from "@sb-labs/web3-data/contracts/TransparentUpgradeableProxy.json" assert { "type" : "json" }

import CometInterface from "@sb-labs/web3-data/contracts/CometInterface.json" assert { "type" : "json" }

import LiquidatableQuery from "@sb-labs/web3-data/contracts/LiquidatableQuery.json"  assert { "type" : "json" }

import OnChainLiquidator from "@sb-labs/web3-data/contracts/OnChainLiquidator.json" assert { "type" : "json" }

import PoolManager from "@sb-labs/web3-data/contracts/PoolManager.json" assert { "type" : "json" }

import MockAsset from "@sb-labs/web3-data/contracts/MockAsset.json" assert { "type" : "json" }

import BasicHook from "@sb-labs/web3-data/contracts/BasicHook.json" assert { "type" : "json" }

import MessagesENS from "@sb-labs/web3-data/contracts/MessagesENS.json" assert {"type": "json"}

import UUIDConnect from "@sb-labs/web3-data/contracts/UUIDConnect.json" assert {"type": "json"}

import PublicKeys from "@sb-labs/web3-data/contracts/PublicKeys.json" assert {"type":"json"}

import Call from "@sb-labs/web3-data/contracts/Call.json" assert {"type":"json"}

import Name from "@sb-labs/web3-data/contracts/Name.json" assert {"type":"json"};
